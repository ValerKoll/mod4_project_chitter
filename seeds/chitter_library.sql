...
INSERT INTO users (name, username, passcode) VALUES ('Peter Pan', 'peterpan', 'peter&1234');
INSERT INTO users (name, username, passcode) VALUES ('Jenny Mill', 'notsoFar', 'docker&1234');
INSERT INTO users (name, username, passcode) VALUES ('kevin Tosh', 'kevin-90', 'linux456789!');
...
INSERT INTO posts (title, content, time_stamp, user_id) VALUES ('title 2', 'Great answer, and comments highlight that in python not everything behaves the way you need it to, but there-s always convenient ways to make it so. The most convenient way is often importing a purpose-built library', '2023-12-10 13:10', 2);  
INSERT INTO posts (title, content, time_stamp, user_id) VALUES ('My motorbike', 'Always one of the most stylish and fun of the retro scrambler breed, the only let-down for the Fantic Caballero 500 was the meagre performance of its somewhat lumpy single-cylinder engine. This new 700cc twin answers that criticism with more power', '2023-12-13 14:50', 3);
